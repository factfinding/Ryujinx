...
namespace ARMeilleure.CodeGen.LoongArch64
{
    static class CodeGenerator
    {
        ...
        private const int FpRegister = 22;
        private const int RaRegister = 1;
...
#pragma warning restore IDE0055
        ...
        public static CompiledFunction Generate(CompilerContext cctx)
        {
            ...
            LoongArch64Optimizer.RunPass(cfg);
        ...
        private static void GenerateAdd(CodeGenContext context, Operation operation)
        {
            ...
            {
                context.Assembler.Fadd(dest, src1, src2);
            }
        }
        ...
        private static void GenerateBranchIf(CodeGenContext context, Operation operation)
        {
            ...
            LoongArch64Condition cond = ((Comparison)comp.AsInt32()).ToLoongArch64Condition();
        ...
        private static void GenerateConditionalSelect(CodeGenContext context, Operation operation)
        {
            ...
            //context.Assembler.Csel(dest, src2, src3, LoongArch64Condition.Ne);
        }
        ...
        private static void GenerateLoad(CodeGenContext context, Operand value, Operand address, int offset)
        {
            ...
            else
            {
                ...
                //context.Assembler.Add(tempAddress, address, tempAddress, LoongArch64ExtensionType.Uxtx); // Address might be SP and must be the first input.
            ...
            else
            {
                ...
                if (frameSize != 0)
                {
                    ...
                    else
                    {
                        ...
                        //context.Assembler.Sub(rsp, rsp, tempSize, LoongArch64ExtensionType.Uxtx);
                    }
                }
            ...
            else
            {
                ...
                if (frameSize != 0)
                {
                    ...
                    else
                    {
                        Operand tempSize = Register(CodeGenCommon.ReservedRegister);
                        GenerateConstantCopy(context, tempSize, (ulong)frameSize);
                        //context.Assembler.Add(rsp, rsp, tempSize, LoongArch64ExtensionType.Uxtx);
                    }
                }
            }
            ...
            AccessSize accessSize)
        {
            ...
            context.JumpToNear(LoongArch64Condition.Ne);
